...
namespace WindowsFormsApp2
{
    ...
    public partial class Продукты : Form
    {
        ...
        void translate(Dictionary<string, string> Words)
        {
            ...
            label2.Text = Words["Проект запущен"];
            label2.Text = Words["Проект запущен"];
        ...
        public Продукты()
        {
            ...
            Ru_word.Add("Проект запущен", "Проект запущен");
            Ru_word.Add("Категория", "Категория");
            Ru_word.Add("Фрукты", "Фрукты");
            Ru_word.Add("Овощи", "Овощи");
            Ru_word.Add("Фастфуд", "Фастфуд");
            Ru_word.Add("Соки", "Соки");
            Ru_word.Add("Рус", "Рус");
            ...
            Eng_word.Add("Применить", "Enter");
            Eng_word.Add("Проект запущен", "Project start");
            Eng_word.Add("Категория", "Category");
            Eng_word.Add("Фрукты", "Fruits");
            Eng_word.Add("Овощи", "хзз");
            Eng_word.Add("Фастфуд", "Fastfood");
